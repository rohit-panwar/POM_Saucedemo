...
public class ProductsPageTest extends TestBase {
	...
	public void sortingTest(String sortByName, String firstProductNameExpected) throws InterruptedException {
		testInfo.log(Status.INFO, MarkupHelper.createLabel("Login using Standard User: " + sortByName, ExtentColor.INDIGO));
		...
		assertEquals(firstProductTextActual, firstProductNameExpected);
